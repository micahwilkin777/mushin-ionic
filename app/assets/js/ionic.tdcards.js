(function(ionic) {
    ...
    var transformKeys = ['webkitTransformOrigin', 'transform-origin', '-webkit-transform-origin', 'webkit-transform-origin', '-moz-transform-origin', 'moz-transform-origin', 'MozTransformOrigin', 'mozTransformOrigin'];
        ...
        return {
            ...
            controller: ['$scope', '$element', '$timeout', function($scope, $element, $timeout) {
                            ...
                            (function(j) {
                                $timeout(function() {
                                    ...
                                    var animation = collide.animation({
                                        ...
                                        existingCards[j].style.transform = existingCards[j].style.webkitTransform = 'translate3d(0, 0, 0) scale(' + scale * v + ')';
                                    })
                                        .start();
                                }, 100 * j);
                            })(i);
                ...
                var bringCardUp = function(card, amt, max, i) {
                    ...
                    card.style.transform = card.style.webkitTransform = 'translate3d(0, 0, 0) scale(' + newScale + ')';
                };
